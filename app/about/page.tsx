...
export const metadata = createPageMetadata({
  title: "About — W.D. Blackwoods",
  description:
    "A note on the archive of What Coffee Demands, its authorial signature, and the literary record taking shape here.",
  path: "/about",
});

export default function AboutPage() {
  return (
    <main className="document-page public-archive-page archive-coffee-beans archive-coffee-beans--about">
      <nav>
        <Link href="/">Home</Link>
